...
public class Car {
    ...
    protected int cylinder; // Fixed spelling from "Cyclinder" in schema to match Java standards
    protected double price;

    public Car() {}

    // Constructor without ID (Used for inserting new cars)
    ...
    // Constructor with ID (Used for updating and viewing data)
